    ...
    >
      ...
      <div className="text-center lg:text-left lg:w-1/2 space-y-4">
        ...
        <p className="text-gray-600 text-lg md:w-4/5">
          Join a community of travel enthusiasts. Share your stories, explore
          new destinations, and get inspired for your next journey. Find the
          best travel tips and experiences tailored just for you.
        </p>
      </div>
