    ...
    <footer className="bg-pink-100 text-black py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-between items-start">
          <div className="mb-6">
            <h2 className="text-lg font-bold">TravelNest</h2>
            <p className="text-gray-400 mt-2">
              We build your unforgettable travel experiences with the passion of
              exploration and the spirit of adventure.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-4 text-center text-gray-500 text-sm">
          <p>Copyright © 2003-2024 TravelNest. All Rights Reserved.</p>
          <p>
            <a
              href="/privacy-policy"
